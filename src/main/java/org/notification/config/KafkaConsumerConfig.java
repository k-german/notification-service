...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UserNotificationEvent> consumerFactory() {
        ...
        JsonDeserializer<UserNotificationEvent> valueDeserializer =
                new JsonDeserializer<>(UserNotificationEvent.class);
        valueDeserializer.addTrustedPackages("org.notification.kafka.dto");

        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), valueDeserializer);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserNotificationEvent>
